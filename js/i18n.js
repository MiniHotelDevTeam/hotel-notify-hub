...
const i18n = {
  ...
  translations: {
    es: {
      ...
      'evolution.connectionHeader': 'Estado de conexión WhatsApp (Evolution API)',
    ...
    en: {
      ...
      'evolution.connectionHeader': 'WhatsApp Connection Status (Evolution API)',
    ...
    pt: {
      ...
      'evolution.connectionHeader': 'Status de Conexão WhatsApp (Evolution API)',
      'evolution.connected': 'Conectado',
      'evolution.connecting': 'Conectando...',
      'evolution.disconnected': 'Desconectado',
